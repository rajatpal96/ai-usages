...
import { UsageEvent } from '../../event-schema/src/index.js';
...
export interface AgentAdapter {
  ...
  transform(payload: unknown, context: BaseTelemetryContext): UsageEvent;
}
...
export class ClaudeCodeAdapter implements AgentAdapter {
  ...
  transform(payload: any, context: BaseTelemetryContext): UsageEvent {
 ...
 */
export class GeminiAntigravityAdapter implements AgentAdapter {
 ...
 */
export class GenericProxyAdapter implements AgentAdapter {
  name = 'generic-proxy';

  canHandle(_payload: any): boolean {
...
export class AdapterRegistry {
  ...
  public resolve(payload: any): AgentAdapter {
  ...
  public normalize(payload: any, context: BaseTelemetryContext): UsageEvent {
