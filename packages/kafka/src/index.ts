...
export class AgentMeterKafkaClient {
  ...
  private memoryFallbackBus = new EventEmitter();
  ...
  public async produceEvent(topic: string, key: string, payload: any): Promise<void> {
  ...
  public async subscribeConsumer(
    ...
    if (this.isFallbackMode || !this.kafka) return;
