          ...
          <div className="space-y-4 relative before:absolute before:inset-0 before:left-4 before:w-0.5 before:bg-slate-800">
            {events.map((evt: any, idx: number) => (
              <div key={evt.eventId || idx} className="relative pl-10 group">
                {/* Timeline Dot */}
                <div className="absolute left-2.5 top-4 w-3.5 h-3.5 -translate-x-1/2 rounded-full bg-slate-950 border-2 border-indigo-500 group-hover:border-emerald-400 transition-colors shadow-[0_0_8px_rgba(99,102,241,0.5)]" />

                <div className="p-4 rounded-2xl glass-panel border border-slate-800 hover:border-slate-700 transition-all space-y-3">
